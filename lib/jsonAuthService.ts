...
const employees: Employee[] = [
  ...
  },
  {
    ...
    role: 'user',
    department: 'HR',
    leaveBalance: { casual: 14, sick: 18, privilege: 22 },
    createdAt: '2024-01-01T00:00:00Z'
  },
  {
    id: 'emp006',
    ...
    role: 'user',
    department: 'Finance',
    leaveBalance: { casual: 11, sick: 16, privilege: 19 },
    createdAt: '2024-01-01T00:00:00Z'
  }
]
...
export function createLeaveRequest(request: Omit<LeaveRequest, 'id' | 'status' | 'requestedAt'>): string {
...
export function processLeaveRequest(requestId: string, status: 'approved' | 'rejected', adminUsername: string, comments?: string): boolean {
